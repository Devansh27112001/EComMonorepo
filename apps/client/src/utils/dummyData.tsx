...
export const tmpSingleProductData: ProductDataType & {
  ...
  shortDescription: productsData[0]!.shortDescription,
  description: productsData[0]!.description,
  price: productsData[0]!.price,
  sizes: productsData[0]!.sizes,
  colors: productsData[0]!.colors,
  images: productsData[0]!.images,
  quantity: 1,
  selectedSize: "m" as string,
...
export const paymentSteps: StepDataType[] = [
  {
    id: 1,
    title: "Shopping Cart",
  },
...
export const tmpCartItems: CartItemDataType[] = [
  {
    id: 1,
    name: "Adidas CoreFit T-Shirt",
    shortDescription:
